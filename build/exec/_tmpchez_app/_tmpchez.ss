...
(define K8-trC-252kiNimekiri (lambda (arg-0 arg-1 ext-0) (let ((e-1 (car arg-0))) (let ((e-2 (cdr arg-0))) (if (null? arg-1) (vector 0 ) (let ((e-5 (car arg-1))) (let ((e-6 (cdr arg-1))) (let ((act-1 (PreludeC-45IO-prim__putStr (string-append (string-append e-1 (string-append " " e-5)) "\xa;") ext-0))) (K8-trC-252kiNimekiri (e-2) e-6 ext-0)))))))))
(define K8-pannkoogid (cons "3 muna" (cons "30g suhkrut" (cons "100g nisujahu" (cons "250g piima" (cons "20g v\xf5;id" (cons "n\xe4;puotsaga soola" '())))))))
(define K8-abi (lambda (arg-0) (cons (string-append (PreludeC-45Show-u--show_Show_Int arg-0) ".") (lambda () (K8-abi (bs+ arg-0 1 63))))))
(define K8-arvud (K8-abi 1))
(collect-request-handler (lambda () (collect) (blodwen-run-finalisers)))
(PrimIO-unsafePerformIO (lambda (eta-0) (K8-trC-252kiNimekiri K8-arvud K8-pannkoogid eta-0)))
  (collect 4)
