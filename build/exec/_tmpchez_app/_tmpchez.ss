#!/nix/store/gl565kwwcdkrnpp2674zfx6bshww02jd-chez-scheme-10.0.0/bin/scheme --program
...
(define K8-readMaybe (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__getStr ext-0))) (let ((sc0 (PreludeC-45Types-u--foldMap_Foldable_List (cons (lambda (arg-8474) (lambda (arg-8477) (PreludeC-45InterfacesC-45BoolC-45Semigroup-u--C-60C-43C-62_Semigroup_AllBool arg-8474 arg-8477))) 1) (lambda (eta-0) (PreludeC-45Types-isDigit eta-0)) (PreludeC-45Types-fastUnpack act-1)))) (cond ((equal? sc0 1) (box (cast-string-boundedInt act-1 31))) (else '()))))))
(define K8-loeArv (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "Sisesta arv: \xa;" ext-0))) (let ((act-2 (K8-readMaybe ext-0))) (if (null? act-2) (let ((act-3 (PreludeC-45IO-prim__putStr "Vale arv!\xa;" ext-0))) (K8-loeArv ext-0)) (let ((e-1 (unbox act-2))) e-1))))))
(define PreludeC-45EqOrd-u--C-62C-61_Ord_Int32 (lambda (arg-0 arg-1) (let ((sc0 (or (and (>= arg-0 arg-1) 1) 0))) (cond ((equal? sc0 0) 0)(else 1)))))
...
(define K8-m2ngWhileR (lambda (arg-0 arg-1 arg-2 ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr (string-append (string-append "Arvan arvu " (PreludeC-45Show-u--show_Show_Int32 arg-2)) "\xa;") ext-0))) (let ((act-2 (PreludeC-45IO-prim__putStr "Kas arv on 1. suurem, 2. v\xe4;iksem v\xf5;i 3. sama?\xa;" ext-0))) (let ((act-3 (K8-loeArv ext-0))) (let ((sc0 (PreludeC-45EqOrd-u--C-62C-61_Ord_Int32 arg-0 arg-1))) (cond ((equal? sc0 1) (PreludeC-45IO-prim__putStr "Sa teed sohki\xa;" ext-0)) (else (cond ((equal? act-3 1) (let ((act-4 ((SystemC-45Random-u--randomRIO_Random_Int32 csegen-15 (cons (bs+ arg-2 1 31) arg-1)) ext-0))) (K8-m2ngWhileR (bs+ arg-2 1 31) arg-1 act-4 ext-0))) ((equal? act-3 2) (let ((act-4 ((SystemC-45Random-u--randomRIO_Random_Int32 csegen-15 (cons arg-0 (bs- arg-2 1 31))) ext-0))) (K8-m2ngWhileR arg-0 (bs- arg-2 1 31) act-4 ext-0))) ((equal? act-3 3) (PreludeC-45IO-prim__putStr "Mina v\xf5;itsin\xa;" ext-0))(else (let ((act-4 (PreludeC-45IO-prim__putStr "Proovi uuesti.\xa;" ext-0))) (K8-m2ngWhileR arg-0 arg-2 act-3 ext-0))))))))))))
(define K8-m2ngR (lambda (ext-0) (let ((act-1 ((SystemC-45Random-u--randomRIO_Random_Int32 csegen-15 (cons 1 100)) ext-0))) (let ((act-2 (PreludeC-45IO-prim__putStr "Proovin arvata sinu m\xf5;eldud arvu.\xa;" ext-0))) (K8-m2ngWhileR 1 100 act-1 ext-0)))))
...
(PrimIO-unsafePerformIO (lambda (eta-0) (K8-m2ngR eta-0)))
  (collect 4)
